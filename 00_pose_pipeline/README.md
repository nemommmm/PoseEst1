...
## Xsens Wording Policy

Xsens should be described as an external comparison/reference system, not as
absolute ground truth. Recommended wording:

- `Xsens-derived reference`
- `agreement with the Xsens comparison system`
- `comparison against Xsens-derived geometric angles`
