...
Usage::
    ...
    /opt/anaconda3/envs/pose/bin/python 00_pose_pipeline/src/visualize_elbow_frames.py \
        --config 00_pose_pipeline/configs/assar2026_fanbo1_a255.yaml \
        --run-dir 00_pose_pipeline/runs/assar2026_fanbo1_a255_angle_test \
        --n-frames 6 \
        --out-dir 00_pose_pipeline/runs/assar2026_fanbo1_a255_angle_test/elbow_viz
"""
